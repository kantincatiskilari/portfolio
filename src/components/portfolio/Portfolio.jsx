    ...
    <div className="portfolio">
     <h1 className="portfolioTitle">
      ...
      >
       {data.map((item) => (
        <SwiperSlide>
          <img src={item.Image} className='swiperImg'/>
          <div className='itemDescContainer'>
            <h3 className="itemDescTitle">{item.Project}</h3>
            <div className="itemDescElement">
              <span><WebIcon /> Project Name: </span>
              <span>{item.Name}</span>
            </div>
            <div className="itemDescElement">
              <span><CodeIcon />Languages: </span>
              <span>{item.Language}</span>
            </div>
            <div className="itemDescElement">
              <span><GitHubIcon /> github Repo: </span>
              <a href={item.Repo} className='link'>Click Here</a>
            </div>
            <div className="itemDescElement">
              <span><DescriptionIcon/> Project Name: </span>
              <span>{item.Name}</span>
            </div>
          </div>
        </SwiperSlide>
